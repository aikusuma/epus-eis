...
export const dashboardInfoContent: InfobarContent = {
  title: 'EIS Dinkes Brebes',
  sections: [
    {
      title: 'Tentang EIS',
      description:
        'Executive Information System (EIS) adalah sistem informasi eksekutif untuk Dinas Kesehatan Kabupaten Brebes. Sistem ini mengintegrasikan data dari e-Puskesmas dan memberikan visualisasi analytics untuk pengambilan keputusan strategis bidang kesehatan.',
      links: [
        {
    ...
    },
    {
      ...
      description:
        'Menampilkan ringkasan KPI kesehatan termasuk total kunjungan, penyakit terbanyak, distribusi gender dan usia, serta tren bulanan. Data diambil dari seluruh puskesmas di Kabupaten Brebes.',
      links: []
    },
    {
      title: 'Fitur Utama',
